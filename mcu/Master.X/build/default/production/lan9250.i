    ...
    while( index < (20) )
    {
        if( (_Bool)(txData[index].flags & (0x0001 << 2)) == 0 )
        {
            ...
            if( pHead != ((void*)0) )
            {
                ...
                txData[index].packetStart = pHead->packetEnd + (4);
            ...
            {
                txData[index].packetStart = (0x0000);
...
void ETH_Init(void)
{
    uint32_t low_addr;
    uint32_t high_addr;
    txCommandA = (0X80000000 | 0x00000000 | 0x00002000 | 0x00001000);
    txCommandB = (0x05200000);
    ...
    LAN_Regwrite32(HW_CFG, (0x00100000 | 0x00050000));
    LAN_Regwrite32(AFC_CFG, 0x006E3741);
    LAN_Bfs(IRQ_CFG, (0xA0000000 | 0x00000100 | 0x00000010 | 0x00000001));
    LAN_Regwrite32(INT_STS, (0xFFFFFFFF));
    LAN_Regwrite32(INT_EN, (0x80000000 | 0x01000000 | 0x00004000 | 0x00000200 | 0x00000008 | 0x04000000));
    LAN_Regwrite32(FIFO_INT, (0x48000000 | 0x00600000 | 0x00000000));
    LAN_Regwrite32(RX_CFG, (0x06000000 | 0x00000400));
    LAN_Bfs(TX_CFG, (0x00000002));
    LAN_Regwrite32(PMT_CTRL, (0x08000000 | 0x02000000 | 0x00400000 | 0x00004000 | 0x00000200 | 0x00000040 | 0x00000020 | 0x00000004| 0x00000002));

    LAN_MACWrite32(HMAC_CR, (0x00100000 | 0x00000100 | 0x00000004 | 0x00000008));

    LAN_Phywrite(PHY_BASIC_CONTROL, (0x2000 | 0x1000 | 0x0100));
    LAN_Phywrite(PHY_AN_ADV, (0x0800 | 0x0400 | 0x0100 | 0x0080 | 0x0040 | 0x0020 | 0x0001));
    LAN_Phywrite(PHY_SPECIAL_MODES, (0x00E0 | 0x0001));
    LAN_Phywrite(PHY_SPECIAL_CONTROL_STATUS_IND, (0x8000 | 0x4000 | 0x0800));
    LAN_Phywrite(PHY_INTERRUPT_MASK, (0x0200 | 0x0080 | 0x0010));
    LAN_Phywrite(PHY_SPECIAL_CONTROL_STATUS, (0x0040));
}
...
void ETH_EventHandler()
{
    ...
    if((intsts & 0x80000000)>0)
    {
        LAN_Bfs(INT_STS, 0x80000000);
    }

    if((intsts & 0x01000000)>0)
    {
        LAN_Bfs(INT_STS, 0x01000000);
    }

    if((intsts & 0x00004000)>0)
    {
        LAN_Bfs(INT_STS, 0x00004000);
    }

    if((intsts & 0x00000200)>0)
    {
        LAN_Bfs(INT_STS, 0x00000200);
    }

    if((intsts & 0x04000000)>0)
    {
        if(phyint & (0x0200 | 0x0010))
        {
    ...
    if((intsts & 0x00000008)>0)
    {
        LAN_Bfs(INT_STS, 0x00000008);
...
void ETH_NextPacketUpdate(void)
{
    ...
    rxLen = ((receiveStatus >> 16)& (0x3FFF));
    dummyOffset = LAN_Regread32(RX_DATA_FIFO);
    do{LATD0 = 0;} while(0);
    SPI1_ExchangeByte((0x03));
    SPI1_ExchangeByte(cmd0);
    SPI1_ExchangeByte(cmd1);
...
static uint32_t LAN_Regread32(lan9250_registers_t address)
{
    ...
    SPI1_ExchangeByte(cmd0);
    SPI1_ExchangeByte(cmd1);
    ((char *) &value)[0] = SPI1_ExchangeByte(0);
    ((char *) &value)[1] = SPI1_ExchangeByte(0);
    ((char *) &value)[2] = SPI1_ExchangeByte(0);
    ((char *) &value)[3] = SPI1_ExchangeByte(0);
    do{LATD0 = 1;} while(0);
...
static void LAN_Regwrite32(lan9250_registers_t address, uint32_t value)
{
    ...
    SPI1_ExchangeByte(cmd0);
    SPI1_ExchangeByte(cmd1);
    SPI1_ExchangeByte(((char *) &value)[0]);
    SPI1_ExchangeByte(((char *) &value)[1]);
    SPI1_ExchangeByte(((char *) &value)[2]);
    SPI1_ExchangeByte(((char *) &value)[3]);
    do{LATD0 = 1;} while(0);
}
...
{
    while(LAN_Regread32(MAC_CSR_CMD)& 0x80000000);
    LAN_Regwrite32(MAC_CSR_CMD, ((offset & 0xFF) | 0x80000000 | 0x40000000));
...
static void LAN_MACWrite32(lan_mac_registers_t offset, uint32_t data)
{
    ...
    LAN_Regwrite32(MAC_CSR_CMD, (0x80000000 | offset));
...
static uint16_t LAN_Phyread(phy_registers_t index)
{
    uint16_t value;
    uint32_t cmd;
    cmd = ((0b00001 & 0x1F) << 11) | ((index & 0x1F) << 6);

    while(LAN_MACRead32(HMAC_MII_ACC)& 0x00000001);
...
{
    uint32_t cmd;
    cmd = ((0b00001 & 0x1F) << 11) | ((index & 0x1F)<< 6) | 0x00000002;
    while((LAN_MACRead32(HMAC_MII_ACC))& 0x00000001);
...
{
    uint16_t free_tx;
    free_tx = (LAN_Regread32(TX_FIFO_INF)) & (0xFFFF);
...
error_msg ETH_WriteStart(const mac48Address_t *dest_mac, uint16_t type)
{
    ...
    if( (ETH_GetFreeTxBufferSize()) < (1600) )
    {
        return BUFFER_BUSY;
    }
...
{
    ethData.pktReady = 0;
    if((LAN_Regread32(RX_FIFO_INF) & 0x0000FFFF) > 0xF)
    {
        LAN_Bfs(RX_DP_CTRL, 0x8000000);
    }
}
...
void ETH_ResetReceiver(void)
{
    ...
    MAC_Bfc(HMAC_CR, 0x00000004);
    intsts = LAN_Regread32(INT_STS);
    while(!(intsts & 0x01000000));
    LAN_Bfs(RX_CFG, 0x00008000);
    LAN_Bfs(INT_STS, 0x01000000);
    MAC_Bfs(HMAC_CR, 0x00000004);
}
...
void ETH_SendSystemReset(void)
{
   LAN_Regwrite32(RESET_CTL, (0x00000001));
}
# 679 "lan9250.c"
uint16_t ETH_TxComputeChecksum(uint16_t position, uint16_t length, uint16_t seed)
{
    ...
    checksum = ((((uint16_t)checksum & (uint16_t)0xFF00) >> 8) | (((uint16_t)checksum & (uint16_t)0x00FF) << 8));
